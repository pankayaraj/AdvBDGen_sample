...
#these are just some text for the generator use as an identifer to generate two different encodings
_good_trigger = "IDICATOR FOR GOOD ENCODING"
_bad_trigger = "IDICATOR FOR BAD ENCODING"
encoder_dir = 'GENERATOR DIRECTORY'
dataset_folder_name = "SAVE FOLDER FOR DATASET"
